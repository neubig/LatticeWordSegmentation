...
HMMCodebook="-HMMCodebook ${4}"                                                           # The HMM codebook size (-HMMCodebookSize N (1024))
HMMNumUnits="-HMMNumUnits ${5}"                                                                         # The number of units in the HMM model (-HMMNumUnits N (100))
# NoThreads='-NoThreads 1'                                                                # The number of threads used for sampling (-NoThreads N (1))
# Debug='-Debug 0'                                                                        # Set debug level (-Debug N (0))
NumIter="-NumIter ${6}"                                                                   # Maximum number of iterations (-NumIter N (0))
...
InputType="-InputType hmm"
LatticeFileType="-LatticeFileType dhmm"
